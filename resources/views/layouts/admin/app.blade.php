        ...
        <div class="sidebar pe-4 pb-3">
            <nav class="navbar bg-light navbar-light" id="navbar">
                <a href="index.html" class="navbar-brand mx-4 mb-3">
                    <h3 class="text-primary"><i class="fa fa-hashtag me-2"></i>FatBurner</h3>
                </a>
                ...
                <div class="navbar-nav w-100">
                    ...
                    <div class="nav-item dropdown">
                        <a href="#" class="nav-link dropdown-toggle" data-bs-toggle="dropdown"><i class="fa fa-table me-2"></i>Nutritionists</a>
                        <div class="dropdown-menu bg-transparent border-0">
                            <a href="{{route('admin.tables')}}" class="nav-item nav-link">Show Nutritionists</a>
                            <a href="{{route('admin.tables.add')}}" class="nav-item nav-link">Add Nutritionist</a>
                        </div>
                    </div>
                ...
                <div class="bg-light rounded-top p-4">
                    <div class="row">
                        <div class="col-12 col-sm-6 text-center text-sm-start">
                            &copy; <a href="{{URL::to('/')}}">FatBurner</a>, All Right Reserved.
                        </div>
                    </div>
                </div>
            </div>
